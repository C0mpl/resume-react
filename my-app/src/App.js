    ...
    <div className="container">
      ...
      <div className="content">
        <div id="section1" ref={sectionRefs.section1} className="first-section">
          ...
          <h2>About Me</h2>
          <p>
            Meticulous iOS developer with 2+ years of experience and passion for the developing process. Reliable and self 
            motivated personality with constant desire to grow and develop.  I worked with applications for realty, social and 
            education. I am a fast learner, eager to learn and share knowledge among co-workers. I work on each project with 
